...
```{r, include=FALSE, purl=F, results="hide"}
...
knitr::purl("fish_flow.Rmd", documentation = 0)
```
...
2.  Regional Generalized Linear Mixed Models (GLMMs)
...
3.  Regional Estimated Marginal Means (EMMs)
...
5. Residual diagnostics for regional GLMMs
...
1.  Summarize transect-level energy flow metrics of each dietary group
...
5.  Relationships between energy flows and significant variables in biotic GLMMs
...
7.  Relationships between energy flows and significant variables in abiotic GLMMs 
```{r, fig.width = 6, fig.height = 8}
